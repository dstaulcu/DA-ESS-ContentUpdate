require([
    ...
    function fetchAnalyticStoryDetails(asName) {
        ...
        let asResults = asSearch.data("results", {count:0});
        ...
        var searchesResults = searchesSearch.data("results", {count:0});
    ...
    function renderStoryAttributes(asAttributes) {
        ...
        $('#narrative').html(asAttributes.narrative);
        $('#description').html(asAttributes.description);
            ...
            let searchPanel = `
                            ...
                            <div class="search_content" id="${searchSelector}-content">
                                <div class="search_left_panel">
                                    <button class="configure_in_es btn btn-primary" id="${ btnID }" data-search-type="${search['action.escu.search_type']}"  data-search-name="${ search['action.escu.full_search_name'] }">Configure in ES</button>
                                    ...
                                    <div class="search_left_attr">
                                        ...
                                        <div class="search_left_attr_value">
                                            ${ search['action.escu.how_to_implement'] }
                                        </div>
                                    </div>
                                    <div class="search_left_attr">
                                        <div class="search_left_attr_label">
                                        ...
                                        <div class="search_left_attr_value">
                                            ${ search['action.escu.known_false_positives'] }
                                        </div>
                                    </div>
                                </div>
            ...
            $(`#${ btnID }`).on('click', (evt) => {
                ...
                if($(evt.target).data("searchType") === "detection") {
                    splunkUtil.redirect_to('app/SplunkEnterpriseSecuritySuite/correlation_search_edit', {
                        search: `${$(evt.target).data("searchName")} - Rule`
                    }, window.open(), true);
                } else {
